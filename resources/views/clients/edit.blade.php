                    ...
                    <form method="POST" action="{{ route('clients.update', $client) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="contact_phone_number" class="block mt-1 w-full" type="text"
                                name="contact_phone_number" :value="old('contact_phone_number', $client->contact_phone_number)" required autofocus
                        ...
                        <!-- Company VAT -->
                        <div class="mt-4">
                            <x-input-label for="name" :value="__('Company VAT')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_address" class="block mt-1 w-full" type="text"
                                name="company_address" :value="old('company_address', $client->company_address)" required autofocus
                        ...
                        <!-- Company city -->
                        <div class="mt-4">
                            <x-input-label for="name" :value="__('Company city')" />
